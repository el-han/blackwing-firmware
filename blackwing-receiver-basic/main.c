...
int main(void)
{
    ...
    while (true)
    {
        ...
        if (packet_received_left)
        {
            ...
            data_buffer[0] = ((data_payload_left[0] & 1<<7) ? 1:0) << 5 | // S00
                             ((data_payload_left[0] & 1<<6) ? 1:0) << 4 | // S01
                             ((data_payload_left[0] & 1<<5) ? 1:0) << 3 | // S02
                             ((data_payload_left[0] & 1<<4) ? 1:0) << 2 | // S03
                             ((data_payload_left[0] & 1<<3) ? 1:0) << 1 | // S04
                             ((data_payload_left[0] & 1<<2) ? 1:0) << 0;  // S05

            data_buffer[2] = ((data_payload_left[0] & 1<<1) ? 1:0) << 5 | // S10
                             ((data_payload_left[0] & 1<<0) ? 1:0) << 4 | // S11
                             ((data_payload_left[1] & 1<<7) ? 1:0) << 3 | // S12
                             ((data_payload_left[1] & 1<<6) ? 1:0) << 2 | // S13
                             ((data_payload_left[1] & 1<<5) ? 1:0) << 1 | // S14
                             ((data_payload_left[1] & 1<<4) ? 1:0) << 0;  // S15

            data_buffer[4] = ((data_payload_left[1] & 1<<3) ? 1:0) << 5 | // S20
                             ((data_payload_left[1] & 1<<2) ? 1:0) << 4 | // S21
                             ((data_payload_left[1] & 1<<1) ? 1:0) << 3 | // S22
                             ((data_payload_left[1] & 1<<0) ? 1:0) << 2 | // S23
                             ((data_payload_left[2] & 1<<7) ? 1:0) << 1 | // S24
                             ((data_payload_left[2] & 1<<6) ? 1:0) << 0;  // S25

            data_buffer[6] = ((data_payload_left[2] & 1<<5) ? 1:0) << 5 | // S30
                             ((data_payload_left[2] & 1<<4) ? 1:0) << 4 | // S31
                             ((data_payload_left[2] & 1<<3) ? 1:0) << 3 | // S32
                             ((data_payload_left[2] & 1<<2) ? 1:0) << 2 | // S33
                             ((data_payload_left[2] & 1<<1) ? 1:0) << 1 | // S34
                             ((data_payload_left[2] & 1<<0) ? 1:0) << 0;  // S35

            data_buffer[8] = ((data_payload_left[3] & 1<<7) ? 1:0) << 5 | // S40
                             ((data_payload_left[3] & 1<<6) ? 1:0) << 4 | // S41
                             ((data_payload_left[3] & 1<<5) ? 1:0) << 3 | // S42
                             ((data_payload_left[3] & 1<<4) ? 1:0) << 2 | // S43
                             ((data_payload_left[3] & 1<<3) ? 1:0) << 1 | // S44
                             ((data_payload_left[3] & 1<<2) ? 1:0) << 0 | // S45
                             ((data_payload_left[3] & 1<<1) ? 1:0) << 6;  // S50
        }
        ...
        if (packet_received_right)
        {
            ...
            data_buffer[1] = ((data_payload_right[0] & 1<<7) ? 1:0) << 1 | // S00
                             ((data_payload_right[0] & 1<<6) ? 1:0) << 2 | // S01
                             ((data_payload_right[0] & 1<<5) ? 1:0) << 3 | // S02
                             ((data_payload_right[0] & 1<<4) ? 1:0) << 4 | // S03
                             ((data_payload_right[0] & 1<<3) ? 1:0) << 5 | // S04
                             ((data_payload_right[0] & 1<<2) ? 1:0) << 6;  // S05

            data_buffer[3] = ((data_payload_right[0] & 1<<1) ? 1:0) << 1 | // S10
                             ((data_payload_right[0] & 1<<0) ? 1:0) << 2 | // S11
                             ((data_payload_right[1] & 1<<7) ? 1:0) << 3 | // S12
                             ((data_payload_right[1] & 1<<6) ? 1:0) << 4 | // S13
                             ((data_payload_right[1] & 1<<5) ? 1:0) << 5 | // S14
                             ((data_payload_right[1] & 1<<4) ? 1:0) << 6;  // S15

            data_buffer[5] = ((data_payload_right[1] & 1<<3) ? 1:0) << 1 | // S20
                             ((data_payload_right[1] & 1<<2) ? 1:0) << 2 | // S21
                             ((data_payload_right[1] & 1<<1) ? 1:0) << 3 | // S22
                             ((data_payload_right[1] & 1<<0) ? 1:0) << 4 | // S23
                             ((data_payload_right[2] & 1<<7) ? 1:0) << 5 | // S24
                             ((data_payload_right[2] & 1<<6) ? 1:0) << 6;  // S25

            data_buffer[7] = ((data_payload_right[2] & 1<<5) ? 1:0) << 1 | // S30
                             ((data_payload_right[2] & 1<<4) ? 1:0) << 2 | // S31
                             ((data_payload_right[2] & 1<<3) ? 1:0) << 3 | // S32
                             ((data_payload_right[2] & 1<<2) ? 1:0) << 4 | // S33
                             ((data_payload_right[2] & 1<<1) ? 1:0) << 5 | // S34
                             ((data_payload_right[2] & 1<<0) ? 1:0) << 6;  // S35

            data_buffer[9] = ((data_payload_right[3] & 1<<7) ? 1:0) << 1 | // S40
                             ((data_payload_right[3] & 1<<6) ? 1:0) << 2 | // S41
                             ((data_payload_right[3] & 1<<5) ? 1:0) << 3 | // S42
                             ((data_payload_right[3] & 1<<4) ? 1:0) << 4 | // S43
                             ((data_payload_right[3] & 1<<3) ? 1:0) << 5 | // S44
                             ((data_payload_right[3] & 1<<2) ? 1:0) << 6 | // S45
                             ((data_payload_right[3] & 1<<1) ? 1:0) << 0;  // S50
        }
